...
class OpenImagesDataset(nn.DataParallel):

    def __init__(self, root,anna_path,
        ...
        self.data, self.class_names, self.class_dict = self._read_data(anna_path)
    ...
    def _getitem(self, index):
        ...
        new_image, new_boxes, new_labels=self.transform(image,boxes,labels)
        return image_info['image_id'],new_image, new_boxes, new_labels
    ...
    def _read_data(self,ann_path):
        annotation_file =ann_path
        print('read on :',ann_path)

        annotations = pd.read_csv(annotation_file)
        # annotations = pd.read_csv(annotation_file)[:1000]
        print(annotations)
        class_names = ['BACKGROUND'] + sorted(list(annotations['LabelName'].unique()))
        class_dict = {class_name: i for i, class_name in enumerate(class_names)}
        data = []
        print('\nReading ',ann_path,'  ing~~~\n')
